...
ALTER TABLE "conversations" ADD COLUMN "wake_policy_json" jsonb DEFAULT '{"agentHumanStep":1,"hierarchyStep":1,"wakeChancePercents":[100,70,50]}'::jsonb NOT NULL;--> statement-breakpoint
